...
class PriceService:
    ...
    def get_acala_usd_price(self) -> float:
        return self.coingecko_client.get_acala_usd_price()

    def get_karura_usd_price(self) -> float:
        return self.coingecko_client.get_karura_usd_price()
    ...
    def get_native_coin_usd_price(self) -> float:
        ...
        if self.ethereum_network == EthereumNetwork.XDAI:
            ...
            return self.get_acala_usd_price()
        elif self.ethereum_network == EthereumNetwork.KAR:
            return self.get_karura_usd_price()
        else:
            try:
